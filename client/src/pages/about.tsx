  ...
  return (
    <div className="min-h-screen bg-#0a2348 flex flex-col items-center justify-start py-8">
      ...
      <div className="w-full flex flex-col items-center">
        <div className="border-4 border-gray-300 rounded-lg overflow-hidden mb-4" style={{maxWidth: '400px'}}>
          <img
            src="https://mercuryvalves.in/wp-content/uploads/2024/01/md-amitkumar-a.n.d.valves_filtered.jpg"
            alt="Amitkumar Mittal - Managing Director"
            className="w-full h-auto object-cover"
          />
        </div>
        <div className="text-center">
          <div className="text-gray-300 text-xl font-semibold">Amitkumar Mittal</div>
          <div className="text-white text-sm font-bold">Managing Director</div>
          <div className="w-32 h-1 bg-red-600 mx-auto mt-2 rounded-full"></div>
        </div>
      </div>
      ...
      <section className="w-full bg-black py-16 px-4 flex flex-col md:flex-row items-center justify-center mt-16 relative">
        ...
        <div className="flex-1 flex justify-end items-center mt-12 md:mt-0 md:ml-8 z-10">
          <img
            src="https://mercuryvalves.in/wp-content/uploads/2024/01/vision-mission-mercury.jpg"
            alt="Vision and Mission"
            className="max-w-xs md:max-w-sm w-full h-auto rounded-xl shadow-2xl object-cover md:absolute md:right-16 md:top-1/2 md:-translate-y-1/2"
            style={{right: 0}}
          />
        </div>
      </section>
      ...
      <section className="w-full flex flex-col items-center justify-center py-16">
        ...
        <div className="w-full e-con-full flex bg-[#0a2348] rounded-xl shadow-lg min-h-[350px] mb-12" style={{minHeight: '350px'}}>
          {/* Map integration placeholder - Elementor-style container */}
        </div>
      </section>
      ...
      <section className="w-full flex flex-col items-center justify-center py-8">
        <div className="w-full max-w-5xl grid md:grid-cols-2 lg:grid-cols-2 gap-12 mb-12">
          ...
          <div className="flex flex-col items-start">
            <span className="inline-block mb-2"><svg width="32" height="32" viewBox="0 0 32 32"><circle cx="16" cy="12" r="10" fill="#e3342f" /><circle cx="16" cy="12" r="6" fill="#e3342f" /><circle cx="16" cy="12" r="3" fill="#fff" /><circle cx="16" cy="28" r="2" fill="#e3342f" /></svg></span>
            <div className="text-white font-bold text-xl mb-2">Coimbatore</div>
            <div className="text-white text-base">Revathika Enterprises<br/>901A, Avinashi Road<br/>Coimbatore-641018, Tel: 94426 16288</div>
          </div>
        </div>
      </section>
